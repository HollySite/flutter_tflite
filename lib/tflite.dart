...
class Tflite {
  ...
  static Future<List<Map<dynamic, dynamic>>?> runModelOnImage({
  ...
  static Future<List<Map<dynamic, dynamic>>?> runModelOnBinary({
  ...
  static Future<List<Map<dynamic, dynamic>>?> runModelOnFrame({
  ...
  static Future<List<Map<dynamic, dynamic>>?> detectObjectOnImage({
    required String path,
  ...
  static Future<List<Map<dynamic, dynamic>>?> detectObjectOnBinary({
    required Uint8List binary,
    String model = 'SSDMobileNet',
    double threshold = 0.1,
    int numResultsPerClass = 5,
  ...
  static Future<List<Map<dynamic, dynamic>>?> detectObjectOnFrame({
    required List<Uint8List> bytesList,
    String model = 'SSDMobileNet',
    int imageHeight = 1280,
    int imageWidth = 720,
  ...
  static Future<List<Map<dynamic, dynamic>>?> runPoseNetOnImage({
    required String path,
    double imageMean = 127.5,
    double imageStd = 127.5,
    int numResults = 5,
  ...
  static Future<List<Map<dynamic, dynamic>>?> runPoseNetOnBinary({
    required Uint8List binary,
    int numResults = 5,
    double threshold = 0.5,
    int nmsRadius = 20,
  ...
  static Future<List<Map<dynamic, dynamic>>?> runPoseNetOnFrame({
    required List<Uint8List> bytesList,
    int imageHeight = 1280,
    int imageWidth = 720,
    double imageMean = 127.5,
